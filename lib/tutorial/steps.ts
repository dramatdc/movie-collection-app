...
export const TUTORIAL_STEPS: TutorialStep[] = [
  {
    ...
    body: "A quick tour — about a minute. Skip anytime, and you can retake it later from your Profile.",
  },
  {
    id: "nav",
    route: "/library",
    ...
    body: "Library, Add, Lists, Pick, and Profile — everything is one tap away down here.",
  },
  {
    id: "recently-added",
    route: "/library",
  ...
  },
  {
    ...
    body: "Feature up to 4 favorites, and keep a Watchlist of movies you want to watch — different from your Wishlist, which is about buying.",
  },
  {
    id: "custom-lists",
    route: "/lists",
  ...
  },
  {
    ...
    title: "Your Profile",
    body: "Turn off sounds or haptics, manage your password, or retake this tour anytime — right here.",
  },
];
